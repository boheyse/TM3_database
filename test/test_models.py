...
class configuration(BaseModel):
    customer_id = ForeignKeyField(id, backref="config")
...
class payment(BaseModel):
    customer_id = ForeignKeyField(id, backref="pay")
...
class delivery(BaseModel):
    customer_id = ForeignKeyField(id, backref="delivery")
    ...
    def add_delivery(customer):

        delivery.create(customer_id = customer, scheduled_delivery = )
